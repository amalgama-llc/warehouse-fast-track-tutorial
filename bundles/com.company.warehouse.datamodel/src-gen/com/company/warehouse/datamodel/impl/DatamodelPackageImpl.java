...
public class DatamodelPackageImpl extends EPackageImpl implements DatamodelPackage {
	 ...
	 * @generated
	 */
	private EClass dockAreaEClass = null;
	 ...
	 */
	@Override
	public EReference getScenario_DockAreas() {
	 ...
	 */
	@Override
	public EClass getDockArea() {
		return dockAreaEClass;
	}
	 ...
	 */
	@Override
	public EReference getDockArea_Scenario() {
		return (EReference) dockAreaEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getDockArea_Id() {
		return (EAttribute) dockAreaEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getDockArea_Direction() {
		return (EAttribute) dockAreaEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getDockArea_StoragePlaces() {
		return (EReference) dockAreaEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(scenarioEClass, SCENARIO__DOCK_AREAS);
		...
		dockAreaEClass = createEClass(DOCK_AREA);
		createEReference(dockAreaEClass, DOCK_AREA__SCENARIO);
		createEAttribute(dockAreaEClass, DOCK_AREA__ID);
		createEAttribute(dockAreaEClass, DOCK_AREA__DIRECTION);
		createEReference(dockAreaEClass, DOCK_AREA__STORAGE_PLACES);
	...
	public void initializePackageContents() {
		...
		forkliftEClass.getESuperTypes().add(this.getAgent());
		...
		initEReference(getScenario_StoragePlaces(), this.getNode(), null, "storagePlaces", null, 0, -1, Scenario.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScenario_DockAreas(), this.getDockArea(), this.getDockArea_Scenario(), "dockAreas", null, 0,
				-1, Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(dockAreaEClass, DockArea.class, "DockArea", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDockArea_Scenario(), this.getScenario(), this.getScenario_DockAreas(), "scenario", null, 0, 1,
				DockArea.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDockArea_Id(), ecorePackage.getEString(), "id", null, 0, 1, DockArea.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDockArea_Direction(), this.getDirection(), "direction", null, 0, 1, DockArea.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDockArea_StoragePlaces(), this.getNode(), null, "storagePlaces", null, 0, -1, DockArea.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
