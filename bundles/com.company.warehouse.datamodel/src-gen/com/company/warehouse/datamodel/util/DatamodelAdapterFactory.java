...
public class DatamodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected DatamodelSwitch<Adapter> modelSwitch = new DatamodelSwitch<Adapter>() {
		...
		@Override
		public Adapter caseDockArea(DockArea object) {
			return createDockAreaAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.company.warehouse.datamodel.DockArea <em>Dock Area</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDockAreaAdapter() {
		return null;
	}
